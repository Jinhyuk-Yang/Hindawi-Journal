...
class DataConverter:
  ...
  def initializeDB(self):
    ...
    nsfcur.execute("INSERT INTO endpointtable (ename, id, data) VALUES ('employees', 50, '221.159.112.1')")
    nsfcur.execute("INSERT INTO endpointtable (ename, id, data) VALUES ('employees', 51, '221.159.112.90')")
    nsfcur.execute("INSERT INTO endpointtable (ename, id, data) VALUES ('employees', 43, '221.159.112.1')")
    nsfcur.execute("INSERT INTO endpointtable (ename, id, data) VALUES ('employees', 44, '221.159.112.90')")
  ...
  def policyprovisioning(self, cfglist):
    ...
    for i in range(nsflen):
      ...
      if isSelected:
        ...
        fo.close()
        #print("CFG time: %s seconds"%(time.time() - temp_start_time))
      #print('')
